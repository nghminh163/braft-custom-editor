...
import BraftFinder from '~/packages/braft-finder';
import mergeClassNames from '~/packages/braft-mergeclassnames';
import { ColorUtils, ContentUtils } from '~/packages/braft-utils';
...
class BraftEditor extends React.Component {
  ...
  onTab = (event) => {
    if (keyCommandHandlers('tab', this.state.editorState, this, event) === 'handled') {
